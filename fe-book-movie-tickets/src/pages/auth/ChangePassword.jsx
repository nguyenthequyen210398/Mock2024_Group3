                ...
                <div className="row">
                    <div className="col-12">
                        <div className="mb-5">
                            ...
                            <p className="text-center m-0">Dont have an account? <a href="signup">Sign up</a></p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="col-12 col-lg-5">
                                <form onSubmit={onSubmit}>
                                    ...
                                    <div className="col-12">
                                        ...
                                        <div className="d-grid">
                                            <button type="button" onClick={returnLogin} className="btn btn-lg btn-light rounded-0 fs-6 mt-3">Cancel</button>
                                        </div>
                                    </div>
                                </form>
                                </div>
